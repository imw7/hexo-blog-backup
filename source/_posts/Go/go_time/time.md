...
时间和日期是我们编程中经常会用到的，本文主要介绍了Go语言内置的time包的基本用法。<!--more-->
...
// 按照指定时区和指定格式解析字符串时间
timeObj, err := time.ParseInLocation("2006/01/02 15:04:05", "2049/10/01 10:15:20", loc)
if err != nil {
	fmt.Println(err)
	return
}
...
1. 获取当前时间，格式化输出为`2019/06/23 20:30:05`格式。
