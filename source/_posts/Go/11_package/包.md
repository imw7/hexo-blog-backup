...
在工程化的Go语言开发项目中，Go语言的源码复用是建立在包（package）基础之上的。本文介绍了Go语言中如何定义包、如何导出包的内容及如何导入其他包。<!--more-->
...
![包中的init()执行时机](https://imw7.github.io/images/Go/package/init01.png)
...
![包之间的init()执行顺序](https://imw7.github.io/images/Go/package/init02.png)
